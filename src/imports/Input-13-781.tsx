import svgPaths from "./svg-c1rjjgdhdd";
...
function Generate() {
  return (
    <div className="absolute bg-[#1f1f1f] bottom-[11px] overflow-clip right-[11px] rounded-[100px] size-[48px]" data-name="Generate">
      <PaperPlane />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute inset-[23.74%]" data-name="Group">
      <div className="absolute inset-[-7.21%_-7.21%_-7.22%_-7.21%]">
