import svgPaths from "./svg-yxea9nwkti";
import imgImageResult from "figma:asset/c912f80d57def8945955d4e9a272f5c913df29c2.png";

function ImageResult() {
  return (
    <div className="relative shrink-0 size-[176px]" data-name="Image Result">
...
export default function SavePopup() {
  return (
    <div className="bg-[#111111] relative rounded-[28px] size-full" data-name="Save Popup">
