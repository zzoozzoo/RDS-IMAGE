import svgPaths from "./svg-50lmu6z6jy";
import imgImageResult from "figma:asset/c912f80d57def8945955d4e9a272f5c913df29c2.png";
import imgImageResult1 from "figma:asset/b339640573b26640b0031e43f186518df8dd01d6.png";
import imgImageResult2 from "figma:asset/522288b58ed1b7ac9544aa86311e10b4394424c3.png";

function Image() {
  return <div className="absolute bg-[#1f1f1f] left-[30px] size-[332px] top-[396px]" data-name="Image" />;
}

function Image1() {
  return <div className="absolute bg-[#1f1f1f] left-[372px] size-[332px] top-[396px]" data-name="Image" />;
}

function Image2() {
  return <div className="absolute bg-[#1f1f1f] left-[714px] size-[332px] top-[396px]" data-name="Image" />;
}

function Right() {
  return (
    <div className="absolute bg-[#111111] h-[1292px] left-[calc(25%+4px)] overflow-clip top-0 w-[1077px]" data-name="Right">
      <Image />
      <Image1 />
      <Image2 />
    </div>
...
function Input() {
  return (
    <div className="absolute bg-[#111111] border border-[#555555] border-solid h-[120px] left-1/2 overflow-clip rounded-[28px] shadow-[0px_2px_8px_-2px_rgba(0,0,0,0.2)] top-[1112px] translate-x-[-50%] w-[713px]" data-name="Input">
      <Touch />
...
function ImageResult2() {
  return (
    <div className="relative shrink-0 size-[300px]" data-name="Image Result">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImageResult2} />
    </div>
  );
}
...
function Image3() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Image 3">
      <ImageResult />
      <ImageResult1 />
      <ImageResult2 />
    </div>
...
export default function HomeImageGenerated() {
  return (
    <div className="bg-black relative size-full" data-name="Home / Image generated">
      <Right />
      <Right1 />
      <Left />
    </div>
