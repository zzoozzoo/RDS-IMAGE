import svgPaths from "./svg-s7m7jl6jz8";
...
function HomeSel() {
  return (
    <div className="basis-0 bg-[#1f1f1f] grow min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="home sel">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center px-[10px] py-[12px] relative w-full">
          <Home />
